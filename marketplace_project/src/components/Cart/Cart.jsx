...
export default function Cart() {
  ...
  const { items, totalPrice, Loading, updateProductQnty, removeProduct, clearCart, shoppingCartId } = useContext(CartContext);
              ...
              <Card className="container mt-5 cartCard p-4">
                <div className="d-flex justify-content-center align-items-center">
                  ...
                  <Card.Body className="text-light ">
                    <Card.Title className="mb-4 fs-2">{item.title}</Card.Title>
                    ...
                    <Button
                      variant="light"
                      onClick={() => updateProductQnty(item.productId, item.quantity + 1)}
                      className="me-4"
                    >
                      +
                    </Button>
